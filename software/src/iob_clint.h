 ...
 * @note The time range of the 64 bit timer is large enough not to consider a
 * wrap around of mtime. An interrupt will be generated at mtime + clock_offset.
 * See
 * http://five-embeddev.com/riscv-isa-manual/latest/machine.html#machine-timer-registers-mtime-and-mtimecmp
 */
